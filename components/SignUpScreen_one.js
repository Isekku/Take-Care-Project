...
import { Text, View, TouchableOpacity, TextInput, Linking, StyleSheet, Image } from 'react-native';
...
function SignUpScreen_one({ navigation }) {
    return (
      ...
      <TouchableOpacity onPress={() => navigation.navigate("Inscription 2")} style={styles.goInscriptionButton}> 
      <View>
        <Image
  ...
  export default SignUpScreen_one;
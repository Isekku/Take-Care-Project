...
function SignUpScreen_three({ navigation }) {
    return (
      ...
      <TextInput placeholder = "Date de naissance" style={styles.styleText}/>
      </View>
      <TouchableOpacity onPress={() => navigation.navigate("Inscription 4")} style={styles.goInscriptionButton}> 
      <View>
        <Image
